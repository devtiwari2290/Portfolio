...
const [images3, setImages3] = useState(data3)
  ...
  return (
    <div className='w-full min-h-screen bg-[#222222] pb-10 pt-20 '>
      <h1 className='text-2xl font-extrabold text-white lg:pt-10  px-5 lg:text-6xl lg:px-14  tracking-normal  md:text-4xl sm:text-3xl' style={{ fontFamily: "china" }}>Things I'm <span className='text-sky-400'>good</span> at</h1>
      ...
      <div className='lg:mt-14 mt-10'>
        ...
        <motion.div className='grid grid-cols-3 lg:flex flex-wrap gap-4 mt-5 mx-9 items-center lg:mx-16 lg:mt-5 '
            ...
            images.map((item, index) => { 
              return (
                ...
                lg:w-[80px] lg:h-[80px]' key={index}>
                  <img className=' w-[55px] h-[55px] object-cover lg:w-[70px] lg:h-[70px]' src={item.image} alt="" />
                </div>
              )
            })
          }
        ...
        >
          {
            images2.map((item, index) => {
              return (
                <div className='w-[70px] h-[70px] bg-white rounded-lg flex items-center justify-center
                lg:w-[80px] lg:h-[80px]' key={index}>
                  <img className='w-[55px] h-[55px]  lg:w-[65px] h-[65px]' src={item.image} alt="" />
                </div>
              )
            })
          }
        ...
        >
          {
            images3.map((item, index) => {
              return (
                <div className='w-[70px] h-[70px] bg-white rounded-lg flex items-center justify-center
                lg:w-[80px] lg:h-[80px] ' key={index}>
                  <img className='w-[55px] h-[55px]  lg:w-[65px] h-[65px] object-cover ' src={item.image} alt="" />
                </div>
              )
            })
          }
