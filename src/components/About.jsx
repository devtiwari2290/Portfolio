  ...
  return (
      ...
      <div className='about w-full min-h-screen bg-[#111111]  pt-14 lg:pt-24 pb-10'>
        <div className='max-w-screen-lg mx-auto pt-10 lg:pt-0 w-full h-full text-white whitespace-nowrap text-wrap tracking-widest px-7 lg:px-0'>
          <h2 className='text-xl text-white text-center leading-loose	lg:text-5xl lg:leading-loose ' style={{ fontFamily: "Moranga" }}>Hi !</h2>
          <h3 className='text-xl text-white text-center font-extrabold  tracking-widest leading-loose lg:text-5xl font-extrabold lg:leading-loose' style={{ fontFamily: "Moranga"  }}>I'm Dev Tiwari, a Full Stack Developer and a UI/UX <br /> designer. I specialize in  about building web applications and UI/UX design & animations.
